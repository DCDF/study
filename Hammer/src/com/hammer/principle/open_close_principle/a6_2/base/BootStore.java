...
public class BootStore {
	...
	static {
		bookList.add(new NovelBook(200, "2元的书", "hammer2"));
		bookList.add(new NovelBook(1000, "10元的书", "hammer10"));
		bookList.add(new NovelBook(3200, "32元的书", "hammer32"));
		bookList.add(new NovelBook(6400, "64元的书", "hammer64"));
	}
